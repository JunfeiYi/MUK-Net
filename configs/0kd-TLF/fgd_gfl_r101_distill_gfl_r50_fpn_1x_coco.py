_base_ = [
    '../../configs/0kd-TLF/gfl_r18_fpn_1x_coco.py'
]
# model settings
...
distiller = dict(
    ...
    teacher_pretrained = 'checkpoints/GFL_T_12_TLF.pth',
    init_student = True,
...
student_cfg = 'configs/0kd-TLF/gfl_r18_fpn_1x_coco.py'
teacher_cfg = 'configs/0kd-TLF/gfl_r101_fpn_1x_coco.py'
